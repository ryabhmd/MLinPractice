...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --tokenizer --tokenizer_input tweet -e data/preprocessing/pipeline.pickle
