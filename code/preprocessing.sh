...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --tokenize --tokenize_input tweet_no_punctuation --stopwords --lemmatize -e data/preprocessing/pipeline.pickle
