...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --emoji_splitter --tokenize --stopwords --lemmatize -e data/preprocessing/pipeline.pickle
