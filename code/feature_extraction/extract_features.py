...
parser.add_argument("--personal_story", action="store_true", help = "check if the tweet contains one of the personal story keywords")
parser.add_argument("--engage_keywords", action="store_true", help = "check if the tweet contains one of the engage keywords")
parser.add_argument("--ner_count", action = "store_true", help = "compute the number of named entities in the tweet")
